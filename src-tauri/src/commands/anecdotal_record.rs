...
//!
//! Sync wiring (Checkpoint 4, ADR-0083) is not yet present -- these
//! commands still call the repository layer directly. See
//! `docs/CURRENT-HANDOFF.md`'s Batch 12 entry.
...
pub fn add_anecdotal_record_followup(
    ...
    anecdotal_record::add_followup(&conn, &school_id, &anecdotal_record_id, &user_id, note)
}
