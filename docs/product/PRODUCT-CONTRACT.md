...
| -------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| SF1 Enrollment                         | **partially built** (Wave 2, ADR-0046): bulk import with conservative provenance-tracked reconciliation, learner photo, enrollment history all built and tested. Transfer foundation deliberately deferred to Wave 5 (needs the cloud/sync layer for a real cross-school receiving entity). ID-generator data foundation satisfied by the existing nullable `Learner.lrn` field — DepEd's own LRN is the identifier here, not a locally-generated one, so no separate generator was needed. | Natural home: combined with the already-planned "UX-05 Learners" scope (see §12).                                                                                                                                                                                                                           |
