# ADR-0060: Admin-Assisted Password Reset (Wave 3N)

Status: Accepted

Reconciliation note (2026-09-01): this decision was originally delivered as
Wave 3I / ADR-0057 on the Claude branch. A parallel Antigravity lineage had
already assigned that identity to SF5. The canonical integrated history keeps
SF5 as Wave 3I / ADR-0057 and renumbers this unchanged password-reset decision
to Wave 3N / ADR-0060.
