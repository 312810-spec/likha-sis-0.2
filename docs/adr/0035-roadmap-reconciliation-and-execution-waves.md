...
| 1    | Foundational primitives                                          | **2/3 complete.** RBAC (`docs/adr/0036`) and curriculum-versioning schema (`docs/adr/0037`) built 2026-08-25; `PRODUCT-CONTRACT.md` §3 was stale claiming otherwise, corrected 2026-08-29. Remaining: School branding (logo→derived theme).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
