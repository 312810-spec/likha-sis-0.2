...
| UX-02 | Teacher Workspace Polish                                      | ✓      | UX-01      | 826bf7d   | e899bbb        | docs/adr/0032-teacher-workspace-polish.md    | npm run quality 352/352, npm run build, npx knip clean (5 pre-existing), check:dev-preview-isolation clean |
