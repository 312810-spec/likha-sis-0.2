 ...
 * `getLoad` is Wave 3A's Teacher Load view -- still not the full
 * Teacher Load/Class Schedule UI (no reassign-in-one-step), just
 * enough for a School Head to assign a teacher, schedule their weekly
 * meetings, and see the resulting derived load.
 */
